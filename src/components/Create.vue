    ...
    <div class="recipe-card">
      <form @submit.prevent="addRecipe" class="recipe-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="description" v-model="recipe.shortDescription" placeholder="E.g., Quick and delicious pasta recipe">
        </div>
        <div>
        ...
        <div>
          ...
          <div v-for="(instruction, index) in recipe.instructions" :key="index" class="instruction-input">
            <textarea v-model="recipe.instructions[index]" placeholder="E.g., Boil the pasta, " class="instruction-input-field"></textarea>
        ...
        <div>
          ...
          <div class="nutrition-values">
            <div v-for="(nutrition, index) in recipe.nutritionValues" :key="index" class="nutrition-input">
              <input type="text" v-model="nutrition.name" :placeholder="nutrition.name" class="nutrition-input-field" disabled>
        ...
        <div class="form-group">
          ...
          <div class="image-input">
            <input type="file" id="image" ref="imageInput" @change="handleImageUpload" accept="image/*" class="image-input-field">
            <button @click="openImageUpload" type="button" class="image-upload-button">Add Image</button>
          </div>
        </div>
